## Función para calcular y graficar ACF y PACF
## usando ggplot2
## Fuente: https://rh8liuqy.github.io/ACF_PACF_by_ggplot2.html#correlogram-formula

corre <- function(data, lag.max = 24, ci = 0.95, large.sample.size = TRUE, horizontal = TRUE,...) {
